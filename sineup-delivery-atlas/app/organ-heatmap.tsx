...
const copy = {
  zh: {
    eyebrow: "全身 ODE 投射",
    title: "AAV 衣壳器官递送热图",
    description: "本图片上小鼠尺度解出的ODE热图，投射在人的器官图做参考",
    capsid: "衣壳",
    metric: "显示指标",
    mapping: "颜色映射",
    absolute: "绝对值",
    ...
    humanDisclaimer: "人体与小鼠使用同一套 Q–PS–Kp–清除–胞内转运方程；生理心输出量与降阶有效交换缩放分别记录，避免把有效流量误称为真实心输出量。人体额外保留串联心肺循环、24 个区域及 CSF/IM depot。",
  ...
  en: {
    ...
    description: "Mouse-scale ODE heatmap projected onto human anatomy for reference",
    capsid: "Capsid",
    metric: "Metric",
    ...
    humanDisclaimer: "Human and mouse views use the same Q–PS–Kp, clearance, and intracellular-trafficking equations. Physiological cardiac output and the reduced-order effective-exchange multiplier are recorded separately so effective flow is not mislabeled as true cardiac output. Human anatomy adds serial cardiopulmonary transit, 24 regions, and CSF/IM depots.",
