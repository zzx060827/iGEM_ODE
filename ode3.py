...
def make_params() -> Dict[str, float | str]:
    ...
    return {
        ...
        # Apparent extracellular AAV clearance, 1/h.
        # k = ln(2) / half-life. Setting ENABLE_APPARENT_AAV_DECAY = False
        # makes all added apparent clearance terms equal to 0.
        ...
        "k_extra_isf_clear_liver": (np.log(2.0) / LIVER_EXTRA_ISF_HALF_LIFE_H) if ENABLE_APPARENT_AAV_DECAY else 0.0,
        "k_extra_isf_clear_spleen": (np.log(2.0) / SPLEEN_EXTRA_ISF_HALF_LIFE_H) if ENABLE_APPARENT_AAV_DECAY else 0.0,
